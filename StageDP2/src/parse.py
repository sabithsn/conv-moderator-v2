...
def main():
    ...
    os.system('bash ' + os.path.join(args.corenlp_dir, 'run_corenlp.sh') + ' ' + args.edu_file_dir)
    time.sleep(2)
    ...
    edu_file_list = [os.path.join(args.edu_file_dir, fname) for fname in os.listdir(args.edu_file_dir) if fname.endswith('.edus')]
    print("edu_file_list: {}".format(edu_file_list))
